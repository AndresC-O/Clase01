...
DELIMITER $$
USE `clase1`$$
CREATE PROCEDURE `SP_I_ESTUDIANTE` (pmatricula int, pidPersona int, pusuario varchar(45), ppass varchar(45), pnie int)
BEGIN
	Insert into estudiante(matricula, idPersona, USU, PASS, NIE) values(pmatricula, pidPersona, pusuario, ppass, pnie);
END$$
DELIMITER ;
